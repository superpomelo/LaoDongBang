...
@interface MyCircleCenterDetails1ViewController ()<UITableViewDelegate,UITableViewDataSource,UITextViewDelegate,SixthMyCircleCenterDetails1TableViewCellDelegate,ThirdMyCircleCenterDetails1TableViewCellDelegate,NoNetWorkViewDelegate>
...
//            [self.rottieView bringSubviewToFront:_animatedView];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    if (section == 2) {
        ...
        [vi addSubview:vibg];
        //线
        UIView *linevibg = [[UIView alloc]initWithFrame:CGRectMake(0, 49.5, SCR_W, 0.5)];
...
//        lb.backgroundColor = [UIColor colorWithRed:255/255.0 green:255/255.0 blue:255/255.0 alpha:1];
        NSMutableAttributedString *attributedString = [[NSMutableAttributedString alloc] initWithString:@"评论" attributes:@{NSFontAttributeName: [UIFont systemFontOfSize:16],NSForegroundColorAttributeName: [UIColor colorWithRed:51/255.0 green:51/255.0 blue:51/255.0 alpha:1.0]}];
    ...
    if (indexPath.section == 0) {
        ...
        if (self.model.imgorvid == 0) {
            if (indexPath.row == 0) {
                ...
                //视频待完善
                SevenMyCircleCenterDetails1TableViewCell *cell = [self.myTableView dequeueReusableCellWithIdentifier:@"SevenMyCircleCenterDetails1TableViewCellID"];
                if (self.model != nil) {
                [cell reloadData:self.model];
                }
                return cell;
