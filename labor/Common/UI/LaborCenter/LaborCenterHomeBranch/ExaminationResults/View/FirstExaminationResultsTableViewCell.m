...
- (void)awakeFromNib {
    ...
    self.textDetailButton.layer.borderColor = [UIColor colorWithRed:80/255.0 green:220/255.0 blue:142/255.0 alpha:1].CGColor;
...
//    self.centerBottomView.layer.borderColor = [UIColor whiteColor].CGColor;
    ...
    gl.colors = @[(__bridge id)[UIColor colorWithRed:38/255.0 green:195/255.0 blue:139/255.0 alpha:1.0].CGColor,(__bridge id)[UIColor colorWithRed:30/255.0 green:200/255.0 blue:136/255.0 alpha:1.0].CGColor];
